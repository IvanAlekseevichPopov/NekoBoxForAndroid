...
Выпилить неиспользуемые ресурсы: значок приложения, значок для шторки, значок на старую кнопку запуска туннеля
Дать ссылку на репозиторий


тестовый релиз

Убрать языки: корейский, японский, варианты китайского, кроме простого.